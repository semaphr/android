...
import com.semaphr.databinding.LayoutSystemMessageOverlayViewBinding

class SystemMessageOverlayView(context: Context, title: String, message: String, dismissable: Boolean) : FrameLayout(context) {
    private var binding: LayoutSystemMessageOverlayViewBinding

    init {
        binding = LayoutSystemMessageOverlayViewBinding.inflate(LayoutInflater.from(context), this, true)
